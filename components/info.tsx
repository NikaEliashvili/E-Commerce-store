  ...
  return (
    <div>
      ...
      <div className="mt-10 flex items-center gap-x-3">
        <Button className="flex items-center gap-x-2 active:scale-95 hover:ring-2 hover:ring-offset-1 hover:ring-yellow-600 hover:text-yellow-400 hover:opacity-100" >
          Add To Cart
